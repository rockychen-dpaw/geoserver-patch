...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script src="/geoserver/openlayers/OpenLayers.js" type="text/javascript">
        </script>
        <script defer="defer" type="text/javascript">
            ...
            function init(){
                ...
                tiled = new OpenLayers.Layer.WMS(
                    "${layerName} - Tiled", "/geoserver/${servicePath}",
                    {
                ...
                untiled = new OpenLayers.Layer.WMS(
                    "${layerName} - Untiled", "/geoserver/${servicePath}",
                    {
                        <#list parameters as param>
                        "${param.name?js_string}": '${param.value?js_string}',
                        </#list>
                ...
                map.events.register('click', map, function (e) {
                    ...
                    OpenLayers.loadURL("/geoserver/${servicePath}", params, this, setHTML, setHTML);
        ...
        <div id="toolbar" style="display: none;">
            <ul>
                ...
                <li>
                    ...
                    <img id="updateFilterButton" src="/geoserver/openlayers/img/east-mini.png" onClick="updateFilter()" title="Apply filter"/>
                    <img id="resetFilterButton" src="/geoserver/openlayers/img/cancel.png" onClick="resetFilter()" title="Reset filter"/>
                </li>
            </ul>
        </div>
        <div id="map">
            <img id="options" title="Toggle options toolbar" src="/geoserver/options.png"/>
        </div>
        <div id="wrapper">
